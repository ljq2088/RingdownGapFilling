...
def ls_fm(paramater,angles):
   ...
   deriv_w21 = (wf.sfa(freq,params_1_p,angles,'lisa',delta_w21_p,para_dtau) - wf.sfa(freq,params_1_m,angles,'lisa',delta_w21_m,para_dtau))/(2* mode_delta)
   ...
   deriv_tau21 = (wf.sfa(freq,params_1_p,angles,'lisa',para_dw,delta_t21_p) - wf.sfa(freq,params_1_m,angles,'lisa',para_dw,delta_t21_m))/(2* mode_delta)
...
def tj_fm(paramater,angles):
   ...
   delta_w21_m = delta_w[:]
   delta_w21_m[1] = -mode_delta
   deriv_w21 = (wf.sfa(freq,params_1_p,angles,'tj',delta_w21_p,para_dtau) - wf.sfa(freq,params_1_m,angles,'tj',delta_w21_m,para_dtau))/(2* mode_delta)
   ...
   delta_t21_m = delta_tau[:]
   delta_t21_m[1] = -mode_delta
   deriv_tau21 = (wf.sfa(freq,params_1_p,angles,'tj',para_dw,delta_t21_p) - wf.sfa(freq,params_1_m,angles,'tj',para_dw,delta_t21_m))/(2* mode_delta)
...
def tq_fm(paramater,angles):
   ...
   delta_w21_m = delta_w[:]
   delta_w21_m[1] = -mode_delta
   deriv_w21 = (wf.sfa(freq,params_1_p,angles,'tq',delta_w21_p,para_dtau) - wf.sfa(freq,params_1_m,angles,'tq',delta_w21_m,para_dtau))/(2* mode_delta)
   ...
   delta_t21_m = delta_tau[:]
   delta_t21_m[1] = -mode_delta
   deriv_tau21 = (wf.sfa(freq,params_1_p,angles,'tq',para_dw,delta_t21_p) - wf.sfa(freq,params_1_m,angles,'tq',para_dw,delta_t21_m))/(2* mode_delta)
