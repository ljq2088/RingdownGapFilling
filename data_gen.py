...
SAVE_PATH_noise_gaps_HugeRangeParas= 'data/SAVE_PATH_noise_gaps_HugeRangeParas.npz'
...
signals, noises,datas,conditions = generate_data(Config.num_samples,TEMP_DIR=TEMP_DIR_4,SAVE_PATH=SAVE_PATH_noise_gaps_HugeRangeParas)
#combine_data()
