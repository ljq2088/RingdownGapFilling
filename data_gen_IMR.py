...
from data.data_generation_IMR import *
import os
...
SAVE_PATH_IMR= 'data/signal_data_IMR.npz'
...
signals,conditions = generate_data(Config.num_samples,TEMP_DIR=TEMP_DIR_4,SAVE_PATH=SAVE_PATH_IMR)
#combine_data()
